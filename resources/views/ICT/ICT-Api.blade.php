            ...
            <div class="row text-center">
                    ...
                    <a class="ancor" href="/post-data">
                        <div class="card latar" style="width: 18rem;border-radius:10%;">
                            <img height="193px"
                                ...
                                class="card-img-top" style="border-top-left-radius: 10%;border-top-right-radius: 10%;"
                                alt="...">
                            <div class="card-body">
                ...
                <div class="col d-flex justify-content-center">
                    <a class="ancor" href="/login">
                        <div class="card latar" style="width: 18rem;border-radius:10%;">
                            <img src="https://images.unsplash.com/photo-1618044619888-009e412ff12a?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=871&q=80"
                                class="card-img-top" style="border-top-left-radius: 10%;border-top-right-radius: 10%;"
                                alt="...">
                            <div class="card-body">
                ...
                <div class="col d-flex justify-content-center">
                    <a class="ancor" href="/kategori">
                        <div class="card latar" style="width: 18rem;border-radius:10%;">
                            <img src="https://images.unsplash.com/photo-1497366754035-f200968a6e72?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=869&q=80"
                                class="card-img-top" style="border-top-left-radius: 10%;border-top-right-radius: 10%;"
                                alt="...">
                            <div class="card-body">
                ...
                <div class="col d-flex justify-content-center">
                    <a class="ancor" href="/wisata">
                        <div class="card latar" style="width: 18rem;border-radius:10%;">
                            <img src="https://images.unsplash.com/photo-1507525428034-b723cf961d3e?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=873&q=80"
                                class="card-img-top" style="border-top-left-radius: 10%;border-top-right-radius: 10%;"
                                alt="...">
                            <div class="card-body">
