...
<body>
    <div class="background">
        <div class="container text-center pading" style="color: #FFF">
            ...
            <p class="mt-3">Registering User to ICT API</p>
        </div>
        ...
        <div class="container custom" style="color: #FFF">
            <form action="/posting" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="city" name="city" class="form-control" id="exampleInputPassword1">
                </div>
                <div class="mb-3">
            ...
            <footer class="fixed-bottom mb-5 text-center">
